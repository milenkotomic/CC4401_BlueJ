    ...
    implements CompileObserver, CallDialogWatcher
{
     ...
     */
    public InvokerTFU(JFrame frame, CallableView member, ResultWatcher watcher, File pkgPath, String pkgName,
     ...
     */
    public InvokerTFU(TabbedFrameUnit pmf, ValueCollection localVars, String command, ResultWatcher watcher)
    {
        initialize(pmf);
     ...
     */
    public InvokerTFU(TabbedFrameUnit pmf, CallableView member, ResultWatcher watcher)
    {
        initialize(pmf);
     ...
     */
    private void initialize(final TabbedFrameUnit pmf)
    {
        this.pmf = pmf;
