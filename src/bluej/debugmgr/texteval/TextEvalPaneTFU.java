 ...
 */
public class TextEvalPaneTFU extends JEditorPane 
    implements Accessible, ValueCollection, ResultWatcher, MouseMotionListener
{
    ...
    public TextEvalPaneTFU(TabbedFrameUnit frame)
    {
        super();
    ...
    public void putError(String message, InvokerRecord ir)
    {
        if(firstTry) {
            if (wrappedResult) {
                ...
                invoker = new InvokerTFU(frame, this, currentCommand, TextEvalPaneTFU.this);
    ...
    public void tagAreaClick(int pos, int clickCount)
    {
        ...
        if(objInfo != null) {
            if(clickCount == 1) {
                DragAndDropHelperTFU dnd = DragAndDropHelperTFU.getInstance();
     ...
     */
    private void inspectObject(TextEvalPaneTFU.ObjectInfo objInfo)
    {
        final TextEvalPaneTFU.ObjectInfo oi = objInfo;
            ...
            if(currentCommand.length() != 0) {
                ...
                if (textParser == null) {
                    textParser = new TextAnalyzer(frame.getProject().getEntityResolver(),
                            frame.getPackage().getQualifiedName(), TextEvalPaneTFU.this);
                }
                String retType;
                ...
                invoker = new InvokerTFU(frame, TextEvalPaneTFU.this, currentCommand, TextEvalPaneTFU.this);
                invoker.setImports(textParser.getImportStatements());
