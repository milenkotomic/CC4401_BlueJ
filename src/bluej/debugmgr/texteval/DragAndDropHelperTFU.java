 ...
 */
public class DragAndDropHelperTFU 
    implements MouseListener, MouseMotionListener
{
   ...
   // private static final int imageHeight = plusDragImage.getHeight(null);
    ...
    private static DragAndDropHelperTFU instance;
    
    /**
     * Lazy instantiation singleton factory method.
     * @return The singleton instance
     */
    public static DragAndDropHelperTFU getInstance()
    {
        if(instance == null) {
            instance = new DragAndDropHelperTFU();
        }
        return instance;
    }
     ...
     */
    private DragAndDropHelperTFU()
    {
    }
    
    public void startDrag(Component source, TabbedFrameUnit frame, 
