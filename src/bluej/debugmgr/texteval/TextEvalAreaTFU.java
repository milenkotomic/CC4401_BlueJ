 ...
 */
public final class TextEvalAreaTFU extends JScrollPane
    implements KeyListener, FocusListener
{
     ...
     */
    public TextEvalAreaTFU(TabbedFrameUnit frame, Font font)
    {
     ...
     */
    private void createComponent(TabbedFrameUnit frame, Font font)
    {
        text = new TextEvalPaneTFU(frame);
