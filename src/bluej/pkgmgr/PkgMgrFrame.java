    ...
    implements BlueJEventListener, MouseListener, PackageEditorListener, FocusListener
{
    ...
    {
    	/*SI:Adaptable a entregar todas las PESTA�AS que esten en el mismo proyecto*/
    ...
    private static PkgMgrFrame instance= null;
    
    public static PkgMgrFrame getInstance(){
    	 if(instance == null)
             instance = new PkgMgrFrame();
         return instance;
